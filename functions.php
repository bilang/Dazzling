...
function dazzling_scripts() {
  ...
  wp_enqueue_style( 'dazzling-bootstrap', "https://cdn.bootcss.com/bootstrap/3.3.7/css/bootstrap.min.css" );
  ...
  wp_enqueue_script('dazzling-bootstrapjs', "https://cdn.bootcss.com/bootstrap/3.3.7/js/bootstrap.min.js", array('jquery') );
