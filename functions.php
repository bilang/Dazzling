...
function dazzling_setup() {
  ...
  add_image_size( 'dazzling-featured', 800, 600, true );
...
function dazzling_scripts() {
  ...
  wp_enqueue_style( 'dazzling-bootstrap', "https://cdn.bootcdn.net/ajax/libs/twitter-bootstrap/3.3.7/css/bootstrap.min.css" );
  ...
  wp_enqueue_script('dazzling-bootstrapjs', "https://cdn.bootcdn.net/ajax/libs/twitter-bootstrap/3.3.7/js/bootstrap.min.js", array('jquery') );
